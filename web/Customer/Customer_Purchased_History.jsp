   ...
   <br>
                ...
                <tbody>
                    <tr class="align-middle alert border-bottom" role="alert">
                        ...
                        <td>
                            <button style="background-color: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 5px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 10px; cursor: pointer;">More Info</button>
                        </td>
                    ...
                    <tr class="align-middle alert border-bottom" role="alert">
                        ...
                        <td>
                            <button style="background-color: #4CAF50; color: white; padding: 10px 20px; border: none; border-radius: 5px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin: 10px; cursor: pointer;" onclick="window.location.href='customerReviewPage.jsp'">More Info</button>
                        </td>
