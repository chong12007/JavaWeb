            ...
            <div class="col-lg-6 text-center text-lg-right">
                <div class="d-inline-flex align-items-center">
                    <div class="btn-group">
                        ...
                        <button type="button" class="btn btn-sm btn-light dropdown-toggle" data-toggle="dropdown">Customer Login</button>
                        <div class="dropdown-menu dropdown-menu-right">


                            <a href="CustomerLogin.jsp"><button class="dropdown-item" type="button">Sign in</button></a>
                            <a href="CustomerLogin.jsp?flag=true"><button class="dropdown-item" type="button">Sign up</button></a>
                ...
                <div class="d-inline-flex align-items-center">                
                    <a href="StaffLogin.jsp"> <button type="button" class="btn btn-sm btn-light ">Staff Login</button></a>        
                </div>
               ...
               <form method="Get" action="../GetSearchResultServlet">
                    <div class="input-group">
                        <input type="search" name="query" class="form-control" placeholder="Search for products">
                         <input type="hidden" name="table"  value="productTableViewGuest">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark py-3 py-lg-0 px-0" style="background-color:rgb(230,206,172); ">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="../GetProduct?action=getAllProductGuest" class="nav-item nav-link"style=" cursor: pointer; transition: background-color 0.3s ease-in-out;" onmouseover="this.style.color = 'black';" onmouseout="this.style.color = 'white';">Shop</a>
