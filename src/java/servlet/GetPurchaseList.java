...
public class GetPurchaseList extends HttpServlet {
   ...
   @PersistenceContext
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String pruchaseIdStr = request.getParameter("purchaseId");
        int purchaseId = Integer.parseInt(pruchaseIdStr);
...
//         session.setAttribute("customerProductList", customerProductList);
        session.setAttribute("StaffPurchaseHistory", customerPurchaseHistoryList);
        session.setAttribute("StaffPaymentList", customerPaymentList);

        
//        if(action.equals("ship"))
        response.sendRedirect("Staff/Purchase_Page.jsp");
    }
