 ...
 * @author chong
 */
public class GetMyPurchase extends HttpServlet {
...
//        if(action.equals("ship"))
        response.sendRedirect("Customer/Customer_Purchased_Ship.jsp");
//        else if(action.equals("receive"))
//            response.sendRedirect("Customer/Customer_Purchased_Receive.jsp");
//        else if(action.equals("history"))
//            response.sendRedirect("Customer/Customer_Purchased_History.jsp");
